...
describe('Notification Approve Team Name Function', () => {
  ...
  test('Success Case: Approve', async () => {
    ...
    await notif_db.notificationApproveTeamNameChange(compId, [teamId], []);
    ...
    expect(notifications1).toEqual(
      expect.arrayContaining([
        expect.objectContaining({
          type: 'name',
          message: `Your coach has approved your new team name for competition ${mockCompetition.name}.`,
        }),
      ])
    );
  ...
  test('Success Case: Reject', async () => {
    ...
    expect(notifications1).toEqual(
      expect.arrayContaining([
        expect.objectContaining({
          type: 'name',
          message: `Your coach has rejected your new team name for competition ${mockCompetition.name}.`,
        }),
      ])
    );
