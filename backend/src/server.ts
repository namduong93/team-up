...
// PARAMS: { staffIds: Array<number> }
// RESPONSE: {}
app.post('/user/staff_requests/approve', userController.staffApprove)

// Reject every staff in the list
// PARAMS: { staffIds: Array<number> }
// RESPONSE: {}
app.post('/user/staff_requests/reject', userController.staffReject)
