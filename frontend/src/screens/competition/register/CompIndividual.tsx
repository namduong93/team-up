...
import { SiteLocation, useMultiStepCompRegoForm } from "./hooks/useMultiStepCompRegoForm";
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        const siteResponse = await sendRequest.get<{site : SiteLocation}>('/competition/user/default_site', { code });
      ...
      <Container>
        <ContentContainer>
          ...
          <div style={{display:'flex', alignContent:'center'}}>
            <Text><em>{formData.siteLocation.name}</em></Text>
          </div>
